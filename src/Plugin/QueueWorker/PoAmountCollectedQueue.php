...
/**
 * Defines 'custom_example_po_amount_collected_queue' queue worker.
 *
 * @QueueWorker(
 *   id = "custom_example_po_amount_collected_queue",
 *   title = @Translation("PO Amount Collected Queue"),
 *   cron = {"time" = 60},
 * )
 */
class PoAmountCollectedQueue extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    $this->logger->info('custom_example_po_amount_collected_worker run completed @ ' . date('Y-m-d H:i:s'));
