...
/**
 * Defines 'custom_example_total_rx_shipment_refills_queue' queue worker.
 *
 * @QueueWorker(
 *   id = "custom_example_total_rx_shipment_refills_queue",
 *   title = @Translation("Total Rx Shipment Refills Queue"),
 *   cron = {"time" = 60},
 * )
 */
class TotalRxShipmentRefillsQueue extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    $this->logger->info('custom_example_total_rx_shipment_refills_worker run completed @ ' . date('Y-m-d H:i:s'));
    ...
    $this->dashboardManager->setBillingCountByDate(
      [
        ...
        'rx_refills_last_update' => date('Y-m-d H:i:s'),
      ],
      [
        'rx_refills' => $total_rx,
        'rx_refills_nids' => $total_rx_nids,
