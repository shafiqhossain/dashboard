...
/**
 * Defines 'custom_example_total_clinics_queue' queue worker.
 *
 * @QueueWorker(
 *   id = "custom_example_total_clinics_queue",
 *   title = @Translation("Total Clinics Queue"),
 *   cron = {"time" = 60},
 * )
 */
class TotalClinicsQueue extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    $this->logger->info( 'custom_example_total_clinics_worker run completed @ ' . date('Y-m-d H:i:s'));

    $total_clinics = $this->dashboardManager->getTotalClinicsByDate();
    ...
    $this->dashboardManager->setBillingCountByDate(
      [
        ...
        'total_clinics_last_update' => date('Y-m-d H:i:s'),
      ],
      [
        'total_clinics' => $total_clinics,
        'total_clinics_last_update' => date('Y-m-d H:i:s'),
