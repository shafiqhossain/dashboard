...
/**
 * Defines 'custom_example_total_amount_collected_queue' queue worker.
 *
 * @QueueWorker(
 *   id = "custom_example_total_amount_collected_queue",
 *   title = @Translation("Total Amount Collected Queue"),
 *   cron = {"time" = 60},
 * )
 */
class TotalAmountCollectedQueue extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    ...
    $this->logger->info('custom_example_total_amount_collected_worker run completed @ ' . date('Y-m-d H:i:s'));
    ...
    // This week
    $total_week = $this->dashboardManager->getTotalRxAmountByWeek(date("Y"), date("W"));
    ...
    // This month
    $total_month = $this->dashboardManager->getTotalRxAmountByMonth(date("Y"), date("n"));
