...
/**
 * Defines 'custom_example_total_rx_scheduled_queue' queue worker.
 *
 * @QueueWorker(
 *   id = "custom_example_total_rx_scheduled_queue",
 *   title = @Translation("Total Rx Scheduled Queue"),
 *   cron = {"time" = 60},
 * )
 */
class TotalRxScheduledQueue extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    $this->logger->info('custom_example_total_rx_scheduled_worker run completed @ ' . date('Y-m-d H:i:s'));
    ...
    $this->dashboardManager->setBillingCountByDate(
      [
        ...
        'rx_scheduled' => $total_rx,
        'rx_scheduled_nids' => $total_rx_nids,
        'rx_scheduled_last_update' => date('Y-m-d H:i:s'),
      ],
      [
        'rx_scheduled' => $total_rx,
        'rx_scheduled_nids' => $total_rx_nids,
