...
class ReportMonthlyClinicVsStaffComparisonForm extends FormBase {
  ...
  */
  ...
  public function getFormID() {
    return 'custom_example_report_monthly_clinic_vs_staff_comparison_form';
  }
   ...
   */
  public function buildForm(array $form, FormStateInterface $form_state, $user_type = NULL, $rx_base_type = NULL, $action_type = NULL, $month = NULL, $year = NULL) {
    if (empty($user_type)) {
      throw new AccessDeniedHttpException('Sorry! No User type reference found.');
    }
