...
class ReportDailyClinicVsStaffCreatedRefillsForm extends FormBase {
  ...
  */
  ...
  public function getFormID() {
    return 'custom_example_report_daily_clinic_vs_staff_created_refills_form';
  }
   ...
   */
  public function buildForm(array $form, FormStateInterface $form_state, $action_type = NULL) {
    ...
    if ($action_type == 'created') {
      ...
      $rx_links = "<h5>Clinic: Today's Rx Created</h5>";
      ...
      $rx_links = "<h5>Staff: Today's Rx Created</h5>";
      $rx_links .= '<table cellspacing="0" cellpadding="5" class="rx-link-list">';
      $rx_links .= '<thead>';
      $rx_links .= '  <tr>';
      $rx_links .= '    <th>Rx</th>';
    ...
    elseif ($action_type == 'refills') {
      ...
      $rx_links = "<h5>Clinic: Today's Rx Refills</h5>";
      $rx_links .= '<table cellspacing="0" cellpadding="5" class="rx-link-list">';
      $rx_links .= '<thead>';
      $rx_links .= '  <tr>';
      $rx_links .= '    <th>Rx</th>';
      ...
      $rx_links = "<h5>Staff: Today's Rx Refills</h5>";
      $rx_links .= '<table cellspacing="0" cellpadding="5" class="rx-link-list">';
      $rx_links .= '<thead>';
      $rx_links .= '  <tr>';
      $rx_links .= '    <th>Rx</th>';
