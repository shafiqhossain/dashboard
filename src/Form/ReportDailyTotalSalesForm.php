...
class ReportDailyTotalSalesForm extends FormBase {
  ...
  */
  ...
  public function getFormID() {
    return 'custom_example_report_daily_sales_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $query->where("DATE_FORMAT(pod.field_po_date_value, '%Y-%m-%d') = :po_date_value", [':po_date_value' => date("Y-m-d")], '=');
    ...
    $query->where("DATE_FORMAT(FROM_UNIXTIME(ord.created), '%Y-%m-%d') = :created", [':created' => date("Y-m-d")], '=');
