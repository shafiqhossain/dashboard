...
class ReportMonthlyPaymentsForm extends FormBase {
  ...
  */
  ...
  public function getFormID() {
    return 'custom_example_report_monthly_payments_form';
  }
   ...
   */
  public function buildForm(array $form, FormStateInterface $form_state, $payment_type = NULL, $month = NULL, $year = NULL) {
    ...
    if ($payment_type == 'successful') {
      ...
      $query->where("YEAR(td.field_tx_date_value) = :tx_date_value", [':tx_date_value' => date("Y")], '=');
      $query->where("MONTH(td.field_tx_date_value) = :tx_date_value", [':tx_date_value' => date("n")], '=');
