...
class ReportMonthlyRxCreatedRefillsForm extends FormBase {
  ...
  */
  ...
  public function getFormID() {
    return 'custom_example_report_monthly_rx_created_refills_form';
  }
   ...
   */
  public function buildForm(array $form, FormStateInterface $form_state, $rx_base_type = NULL, $action_type = NULL, $month = NULL, $year = NULL) {
